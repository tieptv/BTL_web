                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="admin/manufacture/list"><i class="fa fa-bar-chart-o fa-fw"></i>Nhà sản xuất<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/manufacture/list">Danh sách</a>
                                </li>
                                <li>
                                    <a href="admin/manufacture/add">Thêm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
